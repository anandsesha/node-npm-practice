...
console.log(moment().format('MMM Do YY')); // Is the date valid or not. So moment's valid function is used.

console.log(moment().isValid('2020-01-01'));
console.log(moment().isValid('2020-14-01'));
console.log(moment().isValid('01-01')); // Manipulating Dates

console.log(moment().calendar()); // Add 7 to the current date

console.log(moment().add(7, 'days').calendar()); // Add 7 months to the current date

console.log(moment().add(7, 'months').calendar()); // Add 7 years to the current date

console.log(moment().add(7, 'years').calendar());
console.log("-----------"); // subtracts 7 days to current date
...
console.log(b.diff(a, "days")); // Check if moment is After another moment
...
//# sourceMappingURL=/node-npm-practice.e31bb0bc.js.map